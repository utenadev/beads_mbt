...
GitHub Actions のアーティファクトからビルド済みバイナリをダウンロード：

1. [GitHub Actions](https://github.com/utenadev/beads_mbt/actions) を開く
2. 最新の成功したワークフロー（✅）を選択
3. ページ下部の "Artifacts" からプラットフォームを選択：
   - `beads-mbt-linux` - Linux 用
   - `beads-mbt-macos` - macOS 用
   - `beads-mbt-windows` - Windows 用
4. ダウンロードした ZIP を解凍して使用
...
# バイナリは _build/native/debug/build/cmd/main/main.exe
```
